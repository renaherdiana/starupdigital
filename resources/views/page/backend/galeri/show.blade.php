...
<div class="bg-secondary text-center rounded-3 p-4 mb-4 shadow-sm">
    <h1 class="text-white fw-bold mb-0">Detail Galeri</h1>
</div>
    ...
    <div class="col-md-12">
        <div class="bg-secondary rounded-3 shadow-sm p-5 text-white">
            ...
            <div class="text-center mb-5">
                ...
                @else
                    <img src="{{ asset('assetsbackend/img/index.jpg') }}" 
                         ...
                         style="width:180px; height:180px; object-fit:cover;">
                @endif
                <h2 class="fw-bold fs-3">{{ $galeri->title }}</h2>
            </div>
            ...
            <div class="text-center mt-5">
                <a href="{{ route('galeri.index') }}" class="btn btn-danger px-5 py-2 fw-bold">
                    Kembali
                </a>
            </div>
